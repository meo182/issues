defmodule TableFormatterTest do
  ...
  import ExUnit.CaptureIO   # And allow us to capture stuff to stdout
  ...
  def headers_to_string(atom_list) do
    for header <- atom_list, do: Atom.to_string(header)
  end
  ...
  test "column_widths" do
    widths = TF.width_of(split_with_three_columns(), headers_to_string(@headers))
    assert widths == [ 5, 5, 7 ]
  end
